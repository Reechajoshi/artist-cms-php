<script type="text/javascript"> <!--
	...
	{ 
		...
		<?php 
			echo('tabs.addIFrameTab(menuid + "Artworks", CUtil.mergeAssoArr( { name: "Artworks", iframeURL:"'.$me.'?a=art" }, TAB_BASE_PARAMS ) );');
			
			echo('tabs.addIFrameTab(menuid + "Currently", CUtil.mergeAssoArr( { name: "Currently", iframeURL:"'.$me.'?a=cont" }, TAB_BASE_PARAMS ) );');
			
			echo('tabs.addIFrameTab(menuid + "Letimotif", CUtil.mergeAssoArr( { name: "Leitmotif", iframeURL:"'.$me.'?a=leit" }, TAB_BASE_PARAMS ) );');
				
			//echo('tabs.addIFrameTab(menuid + "Images", CUtil.mergeAssoArr( { name: "Images", iframeURL:"'.$me.'?a=img" }, TAB_BASE_PARAMS ) );');
		?>
