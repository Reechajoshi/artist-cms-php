...
<?php
	...
	tabs.addIFrameTab(menuid + 'grpall', { name: 'Groups', iframeURL: '$me?b=grpall', txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid' } );	
